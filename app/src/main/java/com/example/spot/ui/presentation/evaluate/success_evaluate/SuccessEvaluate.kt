package com.example.spot.ui.presentation.evaluate.success_evaluate
...
fun SuccessEvaluate(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                "Agradecemos por avaliar. Sua opinião contribui para uma experiência melhor para todos os usuários.",
